   ...
   public String test(String request, String event) {
        ...
        try {
           ...
           String secretKey = MyNaverInform.chatbot_secret;
            ...
            String message = getReqMessage(request,event); //json형태 질문
   ...
   //암호화해서 전달
    public static String makeSignature(String message, String secretKey) {
        ...
        try {
            ...
            encodeBase64String = Base64.getEncoder().encodeToString(rawHmac); //자바 api 암호화
    ...
    public static String getReqMessage(String voiceMessage, String event) {
        ...
        try {
            ...
            obj.put("event", event); //답변(send) / 웰컴메세지(open) 중 선택
